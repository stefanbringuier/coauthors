...
Welcome to `coauthors` contributor's guide.
...
If you experience bugs or general issues with `coauthors`, please have a look
...
You can help improve `coauthors` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`coauthors` documentation uses [Sphinx] as its main documentation compiler.
This means that the docs are kept in the same repository as the project code, and
that any documentation update is done in the same way was a code contribution.

The markup language for documentation is [CommonMark].



:::{tip}
      Please notice that the [GitHub web interface] provides a quick way of
      propose changes in `coauthors`'s files. While this mechanism can
...
```
conda create -n coauthors python=3 six virtualenv pytest pytest-cov
conda activate coauthors
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/coauthors.git
   cd coauthors
   ```
...
5. Install [pre-commit]:
   ...
   `coauthors` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/stefanbringuier/coauthors
[issue tracker]: https://github.com/stefanbringuier/coauthors/issues
